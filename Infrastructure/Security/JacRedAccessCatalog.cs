...
namespace JacRed.Infrastructure.Security
{
    ...
    public static class JacRedAccessCatalog
    {
        ...
        public static IReadOnlyList<RouteEntry> Routes { get; } = new RouteEntry[]
        {
            ...
            new("/version", JacRedAccessPolicy.Public, "HealthController", "версия протокола для клиентов"),
            new("/version/build", JacRedAccessPolicy.Public, "HealthController", "сведения о сборке"),
