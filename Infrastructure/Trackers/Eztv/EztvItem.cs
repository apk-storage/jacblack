...
namespace JacRed.Infrastructure.Trackers.Eztv
{
    ...
    ///
    /// Источник англоязычных сериалов: около миллиона раздач, авторизация не
    /// нужна, magnet приходит готовым — вместе со списком трекеров, так что
    /// раздача не остаётся жить на одном DHT.
    ///
