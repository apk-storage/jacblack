...
namespace JacBlack.Application.Search
{
    public class JackettSearchService : IJackettSearchService
    {
        ...
        ///
        /// Само описание относится к ResolveCounterpartTitle ниже по файлу:
        /// между ним и методом вставлены другие помощники (живые сиды, отсев
        /// мёртвых, разбор склейки названий).
        /// </summary>
        /// <summary>
