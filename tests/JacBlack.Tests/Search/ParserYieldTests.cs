...
public class ParserYieldTests
{
    ...
    static List<TorrentBaseDetails> Parse(string tracker, string html)
    {
        ...
        {
            case "rutor":
                return JacBlack.Infrastructure.Trackers.Rutor.RutorParser.ParseTorrentsFromPage(html, "1");
            case "nnmclub":
                return JacBlack.Infrastructure.Trackers.NNMClub.NNMClubParser.ParseTorrentsFromPage(html, "1");
            case "kinozal":
                return JacBlack.Infrastructure.Trackers.Kinozal.KinozalParser.ParseTorrentsFromPage(html, "10")
                    .Cast<TorrentBaseDetails>().ToList();
            case "torrentby":
                return JacBlack.Infrastructure.Trackers.TorrentBy.TorrentByParser.ParseTorrentsFromHtml(html, "films");
            case "megapeer":
                return JacBlack.Infrastructure.Trackers.Megapeer.MegapeerParser.ParseTorrentsFromPage(html, "79")
                    .Cast<TorrentBaseDetails>().ToList();
            case "toloka":
                return JacBlack.Infrastructure.Trackers.Toloka.TolokaParser.ParseTorrentsFromPage(html, "16")
                    .Cast<TorrentBaseDetails>().ToList();
            case "selezen":
                return JacBlack.Infrastructure.Trackers.Selezen.SelezenParser.ParseTorrentsFromListPage(html)
                    .Cast<TorrentBaseDetails>().ToList();
            case "anidub":
                return JacBlack.Infrastructure.Trackers.Anidub.AnidubParser
                    .ParseTorrentListFromHtml(html, "https://tr.anidub.com", 1)
                    .Cast<TorrentBaseDetails>().ToList();
            case "animelayer":
                return JacBlack.Infrastructure.Trackers.AnimeLayer.AnimeLayerParser
